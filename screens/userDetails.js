...
export const UserDetailsScreen = (props) => {
      ...
      <ScreenContainer flexstart halfmargin>
        ...
        >
          ...
          >
            ...
            <View style={{flex:1,maxWidth:180, marginLeft:10, marginTop:20}}>
            <Text style={{paddingHorizontal:0, fontSize:20, color:"white", fontWeight:"bold",borderBottomWidth:1, borderBottomColor:"#fff", lineHeight:20}}>Account Details</Text>
            </View>
            <View style={{flex:1,maxWidth:100, marginLeft:10, marginTop:20}}>
            <Text style={{paddingHorizontal:0, fontSize:16, color:"white", fontWeight:"bold",borderBottomWidth:1, borderBottomColor:"#fff", lineHeight:20}}>Next of kin</Text>
            </View>
            <View style={{flex:1, marginHorizontal:10, marginTop:10,flexDirection:"column"}}>
            <TextInput
            placeholder="Name"
            mode="outlined"
            dense={true}
            style={{marginBottom:0, borderRadius:10, backgroundColor:"#ddd"}}
            />
            <TextInput
