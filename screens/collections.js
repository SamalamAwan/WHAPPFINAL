...
export const Collections = ({ navigation }) => {
  ...
  const getFilteredJobByJobID = React.useCallback((JobID) => {   
    ...
    //onPress={() => navigation.navigate('JobStack', { screen: 'Delivery Notes', params: {jobID: 10409, jobDate: '08-11-2021', icon: 'truck-delivery', style:{backgroundColor:"#0078d7"}, isFromStockControl:true } })}
  }, [])
